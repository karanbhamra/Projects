...
// Date: Dec 7, 2010
// Project: Project 3
// Description: The menu gives option to add, delete, change, find, import, export and exit.
//				The add commands adds a new edge, the delete command deletes an existing edge.
//				The change command allows the user to change the weight of an edge.
//				Export command exports to Graph.ser, import reads from the same file.
////////////////////////////////////////////////////////////////
...
public class PathApp
   ...
   public static void findCommand(Graph g) 
   {
	   ...
	   int index = convertChar(vertex); //convert the user input char to corresponding int 

	   System.out.println("Shortest paths");
	   g.path(); // shortest paths
	   
	   System.out.println("Full paths");
	   String path = vertex.toUpperCase();
	   
	   while (index != 0) 
	   {
		   String var = g.getParent(index);
		   index = convertChar(var);
		   path = path.concat("-" + var);
	   }
   ...
   public static Graph importCommand()
   {
	   ...
	   try
       {
          ...
          System.out.println("File import sucessful.");
      }catch(IOException i)
      {
          i.printStackTrace();
